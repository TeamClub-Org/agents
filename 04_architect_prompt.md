...
8. **Следи за размером контекста:** Периодически вызывай команду /compress для суммаризации контекста, чтобы избежать его переполнения
...
- Финальные артефакты (архитектурные документы) пиши на русском языке
