...
5. **Название задачи** для верного понимания контекста где хранить информацию.
...
- Финальные артефакты (план, описания задач) пиши на русском языке
...
❌ **НЕ забывай про размер контекста** — периодически вызывай команду /compress для суммаризации контекста, чтобы избежать его переполнения
